...
<div id="content">
	...
	<div class="curs">
		Курс доллара - 
		<input id="curs_field" type="text" value="<?php echo ("$row[name]");?>" />
		<button class="butt_adm curs_butt">Применить</button>
		<img id="curs_ok" src="img/ok.png" style="display: none;" />
	</div>
	...
	?>
		...
		<div class="product_adm">
			...
			<form action="javascript:void(0);" method="post" id="f<?php echo("$row[id]");?>" name="f<?php echo("$row[id]");?>" enctype="multipart/form-data">
